...
Zuul和Eureka注册发现对接，可以根据服务名动态发现服务实例,与Ribbon集成进行动态负载，从而达到下层的服务实例动态增减，不需要重启Zuul即可达到动态扩容缩容的目的。（Nginx写死后端代码服务地址，无法做到动态调整）

这里我们基于Netflix Zuul创建一个服务网关，将服务能力以Rest接口方式开放出去。
